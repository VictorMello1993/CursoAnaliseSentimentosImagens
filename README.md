...
Os scripts foram testados no Google Colab. Para testá-los, é preciso descompactar o arquivo zipado Material.zip através do código encontrado nos arquivos.py publicados aqui.
